function ret=logspace(x1,x2,n,dim,options)
	arguments(Input)
		x1 dnm{mustBeNonempty}
		x2 dnm{mustBeNonempty}
		n(1,1)double{mustBeInteger,mustBePositive}
		dim(1,1)string="logspace"
	end
	arguments(Input)
	...
	if options.precise
		...
		ret=arrayfun(@(x1,x2)logspace(x1,x2,n)',x1,x2,"uniformoutput",false);
