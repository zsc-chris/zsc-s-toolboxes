function ret=movsum(self,k,dims,nanflag,options)
	arguments(Input)
		self dnm
	...
	dstar=dstarclass;
	ret=applykernel(self,@sum,flatten(zsc.cat(1,num2cell(dims),k)),dstar{options},mode="dist",additionalinput={nanflag});
end