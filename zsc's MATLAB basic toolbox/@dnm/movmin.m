function ret=movmin(self,k,dims,nanflag,options)
	arguments(Input)
		self dnm
	...
	dstar=dstarclass;
	ret=applykernel(self,@(x,dims,nanflag)min(x,[],dims,nanflag),flatten(zsc.cat(1,num2cell(dims),k)),dstar{options},mode="dist",additionalinput={nanflag});
end