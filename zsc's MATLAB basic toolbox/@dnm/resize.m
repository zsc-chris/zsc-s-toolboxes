function ret=resize(self,m,options)
	...
	ret=self.applyalong(@(x,dim,varargin)zsc.resize(x,m,"dimension",dim,varargin{:}),options.Dimension,keepdims=true,additionalinput={dstar{rmfield(options,"Dimension")}});
end