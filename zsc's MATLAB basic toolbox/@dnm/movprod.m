function ret=movprod(self,k,dims,nanflag,options)
	arguments(Input)
		self dnm
	...
	dstar=dstarclass;
	ret=applykernel(self,@prod,flatten(zsc.cat(1,num2cell(dims),k)),dstar{options},mode="dist",additionalinput={nanflag});
end