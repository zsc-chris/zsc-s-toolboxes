function ret=movmedian(self,k,dims,nanflag,options)
	arguments(Input)
		self dnm
	...
	dstar=dstarclass;
	ret=applykernel(self,@median,flatten(zsc.cat(1,num2cell(dims),k)),dstar{options},mode="dist",additionalinput={nanflag});
end