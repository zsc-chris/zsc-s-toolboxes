function ret=movvar(self,k,w,dims,nanflag,options)
	arguments(Input)
		self dnm
	...
	dstar=dstarclass;
	ret=applykernel(self,@(x,dims,nanflag)zsc.var(x,w,dims,nanflag),flatten(zsc.cat(1,num2cell(dims),k)),dstar{options},mode="dist",additionalinput={nanflag});
end